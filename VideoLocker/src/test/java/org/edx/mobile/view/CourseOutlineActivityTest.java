...
public class CourseOutlineActivityTest extends CourseBaseActivityTest {
    ...
    private ActivityController<? extends CourseOutlineActivity> initialize(Intent intent) {
        ...
        assertEquals(data.getSerializable(Router.EXTRA_ENROLLMENT_COURSE_DATA),
                args.getSerializable(Router.EXTRA_ENROLLMENT_COURSE_DATA));
        if (provideCourseId) {
    ...
    public void sectionNavigationTest() {
        ...
        assertEquals(courseData, newData.getSerializable(Router.EXTRA_ENROLLMENT_COURSE_DATA));
