...
public class CourseLectureListActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enrollment = (EnrolledCoursesResponse) getIntent().getSerializableExtra(Router.EXTRA_ENROLLMENT_COURSE_DATA);
        ...
        adapter = new LectureAdapter(this, environment) {
            ...
            public void onItemClicked(LectureModel model) {
                try {
                    ...
                    videoIntent.putExtra(Router.EXTRA_ENROLLMENT_COURSE_DATA, enrollment);
